...
describe('TerminalBlock height cap', () => {
  ...
  it('slices head and tail over the cap and expands on click', () => {
    ...
    const toggle = view.getByRole('button', { name: 'Expand remaining 6 output lines' })
  ...
  it('renders the head slice alone when the cap leaves no tail', () => {
    ...
    expect(view.getByRole('button', { name: 'Expand remaining 4 output lines' })).toBeTruthy()
  })
  ...
  it('caps at the documented default when maxLines is absent', () => {
    ...
    expect(view.getByRole('button', { name: 'Expand remaining 1 output lines' })).toBeTruthy()
  })
})
